...
function verificarEligibilidad() {
    ...
    while (isMayorDeEdad==0) {
        let dia = parseInt(prompt("Ingrese el numero del dia [dd] en que nació: "));
        let mes = parseInt(prompt("Ingrese el numero del mes [mm] en que nació: "));
        let año = parseInt(prompt("Ingrese el numero del año [aaaa] en que nació: "));
        if (añoActual - año > 18) {
            isMayorDeEdad= 1;
